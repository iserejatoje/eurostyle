$(document).ready(function () {
    ...
    script.onload = function() {
        let map;
        if ($(window).width() <= 980) {
            map = L.map('map', {attributionControl: false, scrollWheelZoom: false}).setView([55.342998, 86.090009], 16);
        } else {
            map = L.map('map', {attributionControl: false, scrollWheelZoom: false}).setView([55.342698, 86.089009], 18);
        }
