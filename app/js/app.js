...
$(document).ready(function () {
    ...
    if ($('#map').length > 0) {
        setTimeout(function () {
            ...
            script.src = "/bitrix/templates/eurostyle_new/js/leaflet.min.js";
            ...
            script.onload = function () {
                ...
                let pin = L.icon({
                    iconUrl: '/bitrix/templates/eurostyle_new/images/sprite.svg#pin',
    ...
    let categories = new Swiper('.categories-slider', {
        speed: 400,
        pagination: {
            el: '.categories-slider_wrapper .swiper-pagination',
            clickable: true,
        },
        breakpoints: {
            0: {
